...
def login():
	...
	try:
		head =  {"User-Agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS {iphone} like Mac OS X) AppleWebKit/{iphone1} (KHTML, like Gecko) CriOS/{chrome} Mobile Mobile/{iphone2} Safari/60{h}.1'}
...
def dump(idt,fields,cookie,token):
	try:
		headers = {
			...
			"user-agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebkit/537.36 (KHTML, like Gecko) Crome/110.0.0.0 Mobile Safari/537.36",
